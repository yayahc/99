...
import 'presentation/bloc/favorite_cubit.dart' as _i354;
import 'presentation/bloc/name_cubit.dart' as _i353;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i397.INameDatasource>(() => _i672.LocalNameDatasourceImpl(
        gh<_i460.SharedPreferences>(instanceName: 'pref')));
    ...
    gh.singleton<_i354.FavoriteCubit>(() => _i354.FavoriteCubit(
          gh<_i39.AddNameToFavoriteUsecase>(),
          gh<_i827.GetFavoriteNamesUsecase>(),
          gh<_i536.RemoveNameToFavoriteUsecase>(),
        ));
    gh.singleton<_i353.NameCubit>(
        () => _i353.NameCubit(gh<_i420.GetNamesUsecase>()));
    return this;
  }
}
